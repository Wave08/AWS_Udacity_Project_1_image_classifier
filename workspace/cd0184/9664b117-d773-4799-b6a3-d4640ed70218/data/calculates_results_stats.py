...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Pet Image is a dog - counts number of dog images
        ...
        # Pet Image label Not a Dog
        else:
                if results_dic[key][4] == 0:
                        results_stats_dic['n_correct_notdogs'] += 1
        

        # Calculates run statistics (counts and percentages) below that are 
        # calculated using counters from above

    # Calculates the number of total images
    results_stats_dic['n_images'] = len(results_dic)

    # Calculates number of not-aadog images using - images and dog images count
